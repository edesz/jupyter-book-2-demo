...
Every command from steps 2. to 7. above creates a virtual environment and installs the Python package(s) required to perform the relevant action into that environment.
